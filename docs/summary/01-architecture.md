...
```python
# Роли пользователей (обновлено декабрь 2025)
ROLE_CHOICES = [
    ...
    ("requester", "Просмотр и подача заявки"),  # Просмотр и подача заявки на материал
]
```

**Особенности ролей:**
- **admin**: Полный доступ ко всем функциям
- **manager, warehouse**: Полный доступ, но операции не создают записи в StockSnapshot (без учета изменений)
- **brigadier**: Работа с назначенными объектами, создание закупок и списаний
- **requester**: Только просмотр и создание заявок на материалы
