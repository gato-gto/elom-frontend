    ...
    <template #content>
      <div class="space-y-2 text-sm">
        ...
        <div v-if="material.average_price">
          <span class="text-base-content/60">Средняя цена:</span>
        ...
        <div v-if="material.last_purchase_date">
          <span class="text-base-content/60">Последняя закупка:</span>
