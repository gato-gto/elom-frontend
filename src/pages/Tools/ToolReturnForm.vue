<template>
  <div class="tool-return-form">
    ...
    <div v-if="issue" class="alert alert-info mb-4">
      ...
      <div>
        <div class="font-bold"><span class="font-mono">{{ issue.tool_inventory_number }}</span> — {{ issue.tool_name }}</div>
        <div class="text-sm">Выдан: <span class="font-mono">{{ formatDate(issue.issued_at) }}</span></div>
