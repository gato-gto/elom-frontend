...
async function fetchList(url) {
    ...
    try {
        ...
        if (statusFilter.value)
            query.is_active = statusFilter.value === 'true';
        const q = buildQuery(query);
        const { data } = await api.get(url ?? (endpoints.objects.list + q));
...
for (const [o] of __VLS_getVForSourceType((__VLS_ctx.rows))) {
    // @ts-ignore
    [rows,];
    __VLS_asFunctionalElement(__VLS_elements.tr, __VLS_elements.tr)({
        key: (o.id),
    ...
    __VLS_asFunctionalElement(__VLS_elements.span, __VLS_elements.span)({
        ...{ class: "badge" },
        ...{ class: (o.is_active ? 'badge-success' : 'badge-ghost') },
    });
    ...
    if (__VLS_ctx.canEdit) {
        ...
        __VLS_asFunctionalElement(__VLS_elements.button, __VLS_elements.button)({
            ...
            disabled: (__VLS_ctx.deletingId === o.id),
        });
        // @ts-ignore
        [deletingId,];
        if (__VLS_ctx.deletingId !== o.id) {
            // @ts-ignore
            [deletingId,];
            __VLS_asFunctionalElement(__VLS_elements.svg, __VLS_elements.svg)({
                ...{ class: "w-3 h-3 mr-1" },
        ...
        (__VLS_ctx.deletingId === o.id ? '...' : 'Удал.');
        // @ts-ignore
        [deletingId,];
    }
}
...
// @ts-ignore
[modalOpen,];
/** @type {[typeof ObjectForm, ]} */ ;
// @ts-ignore
const __VLS_4 = __VLS_asFunctionalComponent(ObjectForm, new ObjectForm({
    ...{ 'onSaved': {} },
    ...{ 'onCancel': {} },
